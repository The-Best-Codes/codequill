...
We take the security of CodeQuill seriously. If you discover a vulnerability in our project, please report it to us as soon as possible.
...
2. Open an issue on our [GitHub repository](https://github.com/The-Best-Codes/codequill/issues) with the "vulnerability" label and provide a clear description of the vulnerability, along with any relevant information.
...
We are committed to providing security updates for the following versions of CodeQuill:
...
If you are using an older version of CodeQuill, we strongly recommend upgrading to a supported version to ensure you receive the latest security updates.
...
Thank you for helping us keep CodeQuill secure. If you have any questions or concerns regarding our security policy, please don't hesitate to reach out to us.
